...
concurrently --names "BACKEND,FRONTEND" -c "blue,green" "cd Backend && venv48\Scripts\activate && uvicorn app.main:app --host 127.0.0.1 --port 8000" "cd Frontend\brain-tumor-mri-frontend && npm run dev"
